...
package propertiesObservableList;
...
public class PropertyBasedTableView extends Application {
    ...
    public void start(Stage stage) {
        ...
        final TextField text = new TextField("123");
        ...
        setEmailButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                if (data.size() > 0) {
                    data.get(0).setEmail(text.getText());
        ...
        vbox.getChildren().addAll(label, table, text, setEmailButton, removeRowButton, resetButton);
